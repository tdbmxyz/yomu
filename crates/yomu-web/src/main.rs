...
fn main() {
    ...
    // Native shells restore yomu-store into the synchronous WebView adapter
    // before any component reads it. In a browser this resolves immediately.
    wasm_bindgen_futures::spawn_local(async {
        yomu_ui::offline::restore_shell_store().await;
